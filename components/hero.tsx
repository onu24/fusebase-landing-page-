...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-slate-50 to-cyan-50 px-6 pt-24 pb-20 lg:px-8">
      <div className="mx-auto max-w-[1120px]">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="flex flex-col">
            {/* Badge - 12px margin below */}
            <div className="mb-3 flex items-center p-1 rounded-full border border-slate-200 bg-white/50 backdrop-blur-sm shadow-sm w-fit group cursor-default transition-all duration-300 hover:border-primary/30">
            ...
            {/* Main Heading - 16px margin below */}
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight text-foreground leading-tight mb-4">
              Secure, AI-powered Portals for Teams, Clients & Partners
            </h1>

            {/* Subheading - 24px margin below */}
            <p className="text-lg text-slate-700 leading-relaxed max-w-xl mb-6">
