  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8">
      <section className="relative w-full overflow-hidden rounded-3xl bg-gradient-to-br from-teal-900 via-teal-800 to-slate-900 bg-opacity-90 mx-auto">
        ...
        {/* Content */}
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center justify-center px-8 sm:px-16 pt-18 pb-16">
          <h2 className="mb-3 mt-0 text-balance text-6xl sm:text-7xl font-bold text-white leading-tight text-center">
            Ready to work smarter?
          </h2>

          <p className="mb-6 text-balance text-lg sm:text-xl text-teal-50 max-w-2xl text-center mx-auto">
