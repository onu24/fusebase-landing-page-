...
export function RevenueSection() {
    return (
        <section className="w-full bg-white py-16 px-6 flex flex-col items-center overflow-hidden">
            <div className="max-w-4xl w-full flex flex-col items-center">

                {/* Pure Sketchy Graphic Element */}
                <div className="relative cursor-default group mb-8">
                    ...
                    <div className="relative z-10 flex items-center gap-2.5 px-12 py-5">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-center text-slate-900 leading-[1.15] tracking-tight max-w-3xl">
